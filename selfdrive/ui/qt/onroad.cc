...
void AnnotatedCameraWidget::paintFrogPilotWidgets(QPainter &p) {
  ...
  bool enablePedalIcons = pedalsOnUI && !bigMapOpen;
...
void AnnotatedCameraWidget::drawSLCConfirmation(QPainter &p) {
  ...
  QRect textLeftRect = QRect(leftRect.left(), leftRect.top() + leftRect.height() / 2 - 200, leftRect.width(), leftRect.height() / 2);
  QRect textRightRect = QRect(rightRect.left(), rightRect.top() + rightRect.height() / 2 - 200, rightRect.width(), rightRect.height() / 2);
