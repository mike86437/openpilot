...
void TogglesPanel::updateToggles() {
  ...
  disengage_on_accelerator_toggle->setVisible(!frogpilot_scene.frogpilot_toggles.value("always_on_lateral").toBool());
  auto driver_camera_toggle = toggles["RecordFront"];
  driver_camera_toggle->setVisible(!(frogpilot_scene.frogpilot_toggles.value("no_logging").toBool() && frogpilot_scene.frogpilot_toggles.value("no_uploads").toBool()));
  auto nav_settings_left_toggle = toggles["NavSettingLeftSide"];
  nav_settings_left_toggle->setVisible(!frogpilot_scene.frogpilot_toggles.value("full_map").toBool());
