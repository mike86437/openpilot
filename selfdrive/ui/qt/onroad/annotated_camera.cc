...
void AnnotatedCameraWidget::paintEvent(QPaintEvent *event) {
  ...
  // DMoji
  if (!hideBottomIcons && (sm.rcv_frame("driverStateV2") > s->scene.started_frame) && false) {
...
void AnnotatedCameraWidget::drawStatusBar(QPainter &p) {
  ...
  static const std::map<int, QString> conditionalStatusMap = {
    ...
    {9, tr("Experimental Mode activated for blinker signal")},
    {10, tr("Experimental Mode activated due to no speed limit")},
    {11, tr("Experimental Mode activated for intersection")},
    {12, tr("Experimental Mode activated for upcoming turn")},
    {13, tr("Experimental Mode activated for curve")},
    {14, tr("Experimental Mode activated for slower lead")},
    {15, tr("Experimental Mode activated for stopped lead")},
    {16, tr("Experimental Mode activated for stop light") + (mapOpen ? tr("") : tr(" or stop sign"))},
  };
