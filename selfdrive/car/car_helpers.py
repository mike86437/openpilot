...
def crash_log(candidate):
  ...
  control_keys, vehicle_keys, visual_keys = [
    "AlwaysOnLateral", "PauseLateralOnSignal", "ConditionalExperimentalMode", "ConditionalExperimentalModeSpeed", 
    "ConditionalExperimentalModeSpeedLead", "ConditionalExperimentalModeCurves", "ConditionalExperimentalModeCurvesLead", 
    "ConditionalExperimentalModeSlowerLead", "ConditionalExperimentalModeStopLights", "ConditionalExperimentalModeSignal", 
    "CustomDrivingPersonalities", "AggressivePersonalityValue", "AggressiveJerkValue", "StandardPersonalityValue", "StandardJerkValue", 
    "RelaxedPersonalityValue", "RelaxedJerkValue", "DeviceShutdownTimer", "DrivingPersonalitiesUIWheel", "ExperimentalModeViaWheel", 
    "FireTheBabysitter", "DisableAllLogging", "MuteDM", "MuteDoor", "MuteSeatbelt", "MuteSystemOverheat", "LateralTuning", 
    "AverageDesiredCurvature", "NNFF", "LongitudinalTuning", "AccelerationProfile", "IncreasedStoppingDistance", "AggressiveAcceleration", 
    "SmootherBraking", "NudgelessLaneChange", "LaneChangeTimer", "LaneDetection", "OneLaneChange", "TurnDesires", "DisableInternetCheck", 
    "ReverseCruiseIncrease", "TwilsoncoSSH"
  ], [
    "SNGHack", "TSS2Tune", "ZSS"
  ], [
    ...
    "NumericalTemp", "Fahrenheit", "RotatingWheel", "ScreenBrightness", "Sidebar", "SilentMode", "SteeringWheel", "WideCameraDisable", "HideSpeed"
  ]
