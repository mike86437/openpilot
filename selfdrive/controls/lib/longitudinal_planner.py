...
class LongitudinalPlanner:
  ...
  def update(self, sm):
    ...
    self.mpc.set_weights(prev_accel_constraint, self.custom_personalities, self.aggressive_jerk, self.standard_jerk, self.relaxed_jerk, v_lead0, v_lead1, personality=self.personality)
