...
class LongitudinalMpc:
  ...
  def set_weights(self, prev_accel_constraint=True, custom_personalities=False, aggressive_jerk=0.5, standard_jerk=1.0, relaxed_jerk=1.0, v_lead0=0, v_lead1=0, personality=log.LongitudinalPersonality.standard):
