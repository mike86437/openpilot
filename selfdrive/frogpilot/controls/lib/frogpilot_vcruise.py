...
class FrogPilotVCruise:
  ...
  def update(self, carState, controlsState, frogpilotCarState, frogpilotNavigation, gps_position, v_cruise, v_ego, frogpilot_toggles):
    ...
    if carState.standstill and not self.override_force_stop and controlsState.enabled and frogpilot_toggles. and not (self.frogpilot_planner.tracking_lead and getattr(lead, "dRel", float("inf")) < 15):
