...
from openpilot.selfdrive.frogpilot.frogpilot_variables import CRUISING_SPEED, PLANNER_TIME, THRESHOLD, State
...
class FrogPilotPlanner:
  ...
  def update(self, carState, controlsState, frogpilotCarState, frogpilotNavigation, liveLocationKalman, modelData, radarless_model, radarState, frogpilot_toggles):
    ...
    if controlsState.state == State.enabled:
    ...
    if controlsState.state == State.enabled and frogpilot_toggles.conditional_experimental_mode:
