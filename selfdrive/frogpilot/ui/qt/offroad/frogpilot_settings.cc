...
void FrogPilotSettingsWindow::createPanelButtons(FrogPilotListWidget *list) {
  ...
  std::vector<std::tuple<QString, QString, QString>> panelInfo = {
    ...
    {tr("Navigation"), tr("Manage map data to be used with 'Curve Speed Control' and 'Speed Limit Controller' and setup 'Navigate On openpilot (NOO)'."), "../frogpilot/assets/toggle_icons/icon_map.png"},
